...
namespace Tests.Internal
{
    ...
    public class SystemTextJsonConfigurationSerializerTests
    {
        ...
        [Test, CustomAutoData]
        public void Object_is_correctly_serialized(SystemTextJsonConfigurationSerializer sut, ObjectWithInnerObject testSource, string rootSectionName)
        {
            var result = sut.Serialize(testSource, rootSectionName);
        ...
        [Test, CustomAutoData]
        public void Object_with_array_is_correctly_serialized(SystemTextJsonConfigurationSerializer sut, ObjectWithSimpleStringArray testSource, string rootSectionName)
        {
            var result = sut.Serialize(testSource, rootSectionName);
        ...
        [Test, CustomAutoData]
        public void Object_with_array_is_correctly_serialized(SystemTextJsonConfigurationSerializer sut, ObjectWithSimpleIntArray testSource, string rootSectionName)
        {
            var result = sut.Serialize(testSource, rootSectionName);
        ...
        [Test, CustomAutoData]
        public void Object_with_array_is_correctly_serialized(SystemTextJsonConfigurationSerializer sut, ObjectWithComplexArray testSource, string rootSectionName)
        {
            var result = sut.Serialize(testSource, rootSectionName);
        ...
        [Test, CustomAutoData]
        [Property("Issue", "2")]
        public void Importing_same_object_twice_should_not_throw(SystemTextJsonConfigurationSerializer sut, ObjectWithComplexArray testSource, string rootSectionName)
        {
        ...
        [Test, CustomAutoData]
        [Property("Issue", "2")]
        public void Null_values_should_not_be_added(SystemTextJsonConfigurationSerializer sut, ObjectWithSimpleProperties testSource, string rootSectionName)
        {
